...
#
# def draw_grid():
#     pygame.draw.line(screen, (0, 0, 0),(400, 0), (400, 1200), 3)
#     pygame.draw.line(screen, (0, 0, 0),(800, 0), (800, 1200), 3)
#     pygame.draw.line(screen, (0, 0, 0),(0, 400), (1200, 400), 3)
#     pygame.draw.line(screen, (0, 0, 0),(0, 800), (1200, 800), 3)
# draw_grid()
#
...
# def draw_x(x, y, size):
#     padding = size // 6
#     pygame.draw.line(screen, RED, (x + padding, y + padding),(x + size - padding), size // 10)
...
#         return True
#
# def ai_turn():  #Ход компьютера
#     empty_cells = []
#     for i in range(3):
#         for j in range(3):
#             if field[i][j] =="":
#                 empty_cells.append((j,i))  #Сохраняем координаты пустых клеток
#
#     if empty_cells:
#         x,y = random.choice(empty_cells)  #Выбираем случайную пустую клетку
#         field[y][x] = "0"
#
# def draw_win_line():
#     if win:
...
#         pygame.draw.line(screen,RED,start_pos,end_pos,10)  #толщину можно настроить
# # pygame.display.flip()
#
